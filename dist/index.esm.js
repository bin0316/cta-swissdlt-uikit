...
var Icon$q = function (props) {
    return (React.createElement("svg", { version: "1.0", xmlns: "http://www.w3.org/2000/svg", width: "300pt", height: "300pt", viewBox: "0 0 392.000000 359.000000", preserveAspectRatio: "xMidYMid meet" },
        React.createElement("g", { transform: "translate(0.000000,359.000000) scale(0.100000,-0.100000)", fill: "#004aad", stroke: "none" },
            React.createElement("path", { d: "M1780 3539 c-408 -39 -821 -245 -1101 -548 -233 -253 -375 -536 -446\n-886 -26 -129 -26 -491 0 -620 55 -274 150 -497 302 -710 491 -687 1409 -926\n2170 -566 517 245 865 697 982 1276 26 129 26 491 0 620 -55 273 -151 497\n-302 709 -365 512 -972 786 -1605 725z m-315 -1046 c87 -156 161 -283 164\n-283 3 0 82 140 175 310 93 171 173 307 177 303 4 -5 91 -233 194 -508 103\n-275 189 -502 191 -504 2 -2 15 4 30 14 77 50 260 78 374 57 75 -14 166 -49\n197 -76 19 -17 24 -28 19 -44 -10 -30 -42 -28 -93 7 -56 38 -167 65 -245 59\n-52 -4 -65 -9 -85 -33 -47 -54 -20 -91 182 -248 176 -137 269 -231 307 -313\n28 -60 30 -72 26 -147 -5 -97 -26 -143 -90 -203 -79 -74 -152 -107 -278 -124\n-143 -20 -331 15 -432 79 -52 33 -65 72 -30 89 21 12 31 8 92 -33 83 -56 139\n-70 275 -70 136 0 184 15 211 67 33 65 -19 127 -239 285 -242 174 -327 280\n-327 409 0 34 4 74 10 88 l10 26 -154 0 -154 0 -15 43 c-60 170 -190 524 -196\n535 -5 8 -63 -93 -158 -275 -83 -158 -154 -288 -158 -288 -5 0 -78 116 -164\n257 -86 141 -159 257 -162 258 -3 0 -52 -119 -110 -265 l-104 -265 -32 0 c-18\n0 -33 3 -33 7 0 3 63 166 139 362 77 196 171 443 210 550 39 106 74 198 77\n203 8 12 4 18 199 -329z" }))));
};
...
var Icon$p = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React.createElement("path", { d: "M103,31.17V31c0-11.63-8.41-22.27-21-22.27-10,0-15.87,7.22-17.86,14h0c-2-6.76-7.81-14-17.86-14-12.64,0-21,10.64-21,22.27v.18c-.07,2.53,0,28.27,38.9,49.26h0C103,59.44,103.06,33.7,103,31.17Z", transform: "translate(-25.17 -8.72)", fill: "#004aad" })));
};

var float = keyframes(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"])));
var Container$3 = styled.div(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var RotatingPancakeIcon = styled(Icon$p)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled(Icon$q)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var Logo = function (_a) {
    ...
    (React.createElement(React.Fragment, null,
        React.createElement(Text, { fontSize: "23px" }, " Urstamm Exchange "),
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Urstamm Exchange" },
            React.createElement(Text, { fontSize: "23px" }, " Urstamm Exchange "))) : (React.createElement(StyledLink, { to: href, "aria-label": "Urstamm Exchange" },
            React.createElement(Text, { fontSize: "23px" }, " Urstamm Exchange ")))));
};
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://swissdltexplorer.com/address/" + account, mr: "16px" }, "View on Explorer"),
